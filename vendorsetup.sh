...
git clone https://github.com/AlphaDroid-devices/vendor_xiaomi_garnet.git -b alpha-14 vendor/xiaomi/garnet

# Kernel
echo 'Cloning kernel tree'
git clone https://github.com/AlphaDroid-devices/device_xiaomi_garnet-kernel.git -b alpha-14 device/xiaomi/garnet-kernel
